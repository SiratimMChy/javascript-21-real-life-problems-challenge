...
2. **Discount Calculator**
   Calculate the discount and final price based on different purchase amount ranges.
...
5. **Login System**
   Create a function that checks a user's email and password against a list of registered users and returns an appropriate login message.
...
8. **Out-of-Stock Products**
   Given an array of products with stock information, return only the products that are currently out of stock.
...
11. **Employee Department Report**
    Given an array of employees, calculate the employee count, total salary, and average salary for each department.
...
14. **Expense Tracker**
    Given an array of expenses with different categories, calculate the total expense for each category and the overall expense.
...
20. **Shopping Cart Manager**
    Create functions to add products, remove products, update quantities, calculate the total, and clear the shopping cart.

21. **Mini Banking System**
    Create a simple banking system with functions for creating accounts, depositing money, withdrawing money, checking balance, and transferring money between accounts.
